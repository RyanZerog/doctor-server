  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <div className="tag-name-column">
          <Tag color={record.color} key={record.id} className="tag-display">
          ...
          <div className="used-by-patients">
            ...
            <div className="patient-avatars">
              {usedByPatients.map((patient, index) => (
                <Tooltip key={patient.id} title={patient.name}>
                  <Avatar 
                    size="small"
                    style={{ 
                      backgroundColor: patient.gender === '男' ? '#1D5B79' : '#eb2f96',
